...
|------|----------|------|-------------------|
| **RL Yakınsamıyor (Öğrenmiyor)** | 🟡 Orta | 🔴 Kritik | Q-Learning yerine daha basit bir ödül mekanizması kullan veya eğitimi önceden yapıp "pre-trained model" yükle |
| **UI Donması (Not Responding)** | 🔴 Yüksek | 🔴 Yüksek | Tüm hesaplamaları kesinlikle QThread veya multiprocessing içinde yap |
| **250 Düğümde Yavaşlık** | 🔴 Yüksek | 🟡 Orta | Görselleştirmeyi sadece sonuç bulunduğunda yap (animasyonu kapat), NetworkX yerine numpy matris işlemleri kullan |
| **Git Çakışmaları** | 🔴 Çok Yüksek | 🟡 Orta | `main` dalına doğrudan commit yasak. Her özellik (feature) ayrı dalda yapılacak |

---

## 6. Literatürden Dersler

> **Benzer Projeler Neden Başarısız Oldu?**

### ⚠️ Aşırı Karmaşık Görselleştirme

**Problem:** Her iterasyonu (her karıncanın hareketini) canlı çizdirmeye çalışmak sistemi kilitler.

**Çözüm:** Sadece en iyi rotayı çizdirin veya çizimi 100 iterasyonda bir güncelleyin.

---

### ⚠️ Yanlış Parametreler

**Problem:** GA popülasyonu çok küçükse (örn. 10) yerel optimuma takılır, çok büyükse (örn. 1000) çok yavaş çalışır.

**Çözüm:** Dinamik parametre ayarı veya literatürdeki standart değerleri (Pop: 50-100) kullanın.

---

### ⚠️ Hafıza Sızıntısı

**Problem:** Python'da sürekli yeni nesne üretip silmemek RAM'i şişirir.

**Çözüm:** Nesneleri döngü içinde tekrar kullanın.
